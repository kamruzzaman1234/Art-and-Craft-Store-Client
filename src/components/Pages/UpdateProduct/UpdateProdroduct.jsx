        ...
        <div className="w-full">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="form-control">
              ...
              <input type="text" defaultValue={displayName} name="user_displayName" className="input input-bordered" required/>
            </div>
            <div className="form-control">
              <label htmlFor="user_email" className="mb-2 font-bold">Email</label>
              <input type="email" defaultValue={email} name="user_email" className="input input-bordered" />
            </div>
            <div className="form-control">
